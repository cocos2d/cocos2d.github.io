window.apimeta = {
  ...
  "classes": [
    ...
    {
      "name": "AssetTable",
      "namespace": "cc.AssetTable",
      "module": "cc",
      "description": "<p><p>AssetTable is used to find asset's uuid by url</p></p>\n"
    },
    {
      "name": "AudioClip",
    ...
    },
    {
      ...
      "module": "cc",
      "description": "<p>LoadingItems is the manager of items in pipeline.\nIt hold a map of items, each entry in the map is a url to object key value pair.\nEach item always contains the following property:</p>\n<ul>\n<li>src: The url</li>\n<li>type: The type, it's the extension name of the url by default, could be specified manually too</li>\n<li>error: The error happened in pipeline will be stored in this property</li>\n<li>content: The content processed by the pipeline, the final result will also be stored in this property</li>\n<li>complete: The flag indicate whether the item is completed by the pipeline</li>\n<li>states: An object stores the states of each pipe the item go through, the state can be: Pipeline.ItemState.WORKING | Pipeline.ItemState.ERROR | Pipeline.ItemState.COMPLETE</li>\n</ul>\n<p>Item can hold other custom properties</p>\n"
    },
    {
      "name": "Mask",
      "namespace": "cc.Mask",
